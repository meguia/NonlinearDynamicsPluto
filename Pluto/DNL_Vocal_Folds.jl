...
using DifferentialEquations, Parameters,Plots, PlutoUI, JLD2, GLM, DataFrames
...
md"""
x0 $(@bind x0 Slider(-1.0:0.1:2.0,default=0.1;show_value=true)) \
...
# ╔═╡ 69d8bedc-e3cc-4851-b88c-3a44ed7314bb
prob = ODEProblem(vfolds!,[x0,y0], (0,tmax), par)

# ╔═╡ 9e114fa1-2cf9-4548-8c39-bb7e5d27fb69
sol = solve(prob,alg);

# ╔═╡ d9deb3a3-d51b-4822-9517-b33f9f8c3380
plot(sol,idxs=(0,1))

# ╔═╡ 22f319d1-c44f-4217-a4bd-30ba254f3926
2*pi/sqrt(k)
...
manifest_format = "2.0"
project_hash = "febea152bae0684e7c1f09a2d84c7e26a3e8e3c9"
