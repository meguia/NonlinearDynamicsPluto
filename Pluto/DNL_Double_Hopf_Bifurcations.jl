...
par_d = (μ1=-0.4,μ2=-0.4,k1=0.1,k2=0.19,σ2=-0.2,c12=0.1,c21=-0.1,ξ=-0.1)
...
# ╔═╡ ac49c1e7-a709-4653-a9ce-b0cb13a0ce09
...
opts_br2 = ContinuationPar(p_max = 0.4, p_min = -0.4,dsmax=0.01,dsmin=1e-4,ds=1e-4,max_steps = 300,n_inversion = 4);

# ╔═╡ 7aeb774f-d2b3-4ec8-8c56-cc5d80b6091f
par_d.c12

# ╔═╡ 0df18c34-9d72-4893-9245-abee78baeebd
br2 = continuation(prob2, PALC(), opts_br2, bothside = true)

# ╔═╡ fed8c33b-7d8e-4176-9ffe-4641b51eb007
...
# ╔═╡ 2e748e39-118f-4894-b147-c7f69477c25b
...
opts_ns = ContinuationPar(opts_br2, detect_bifurcation = 1, max_steps = 300, detect_event = 0, ds = 0.001);

# ╔═╡ 458beebf-9853-4559-8498-7c307cee03d8
ns_po1 = continuation(hopf_1b, 2, opts_ns, PeriodicOrbitOCollProblem(20, 3, update_section_every_step = 1);
...
begin
	...
	plot!(ns_po2,branchlabel = "NS 2",c=:black,ls=:dot,plotspecialpoints = false,ylims=(-0.4,0.4))
