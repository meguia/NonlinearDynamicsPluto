...
md"""
x0 $(@bind x0 Slider(-1.0:0.1:1.0,default=0.1;show_value=true)) \
τ : $(@bind τ Slider(0.0:0.01:3.73,default=0.1;show_value=true)) \
fτ : $(@bind fτ Slider(0.0:0.01:5,default=0.1;show_value=true)) \
tend : $(@bind tend Slider(10:10:1000.0,default=10.0;show_value=true)) 
"""
